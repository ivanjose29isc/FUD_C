            ...
            switch (categoria)
            {
                case "A":
                    ...
                    Console.WriteLine("El maestro de nombre: {0}, con categoria {1}, y un total" +
                         "de {2} horasa a la semana, tendra una remuneracion de ${3}," +
                ...
                case "B":
                    ...
                    if (numeroHoras < 13)
                    {
                        Console.WriteLine("Incumplimiento de horas, la categoria C debe traer mas de 13 horas asignadas, vuelva a intentarlo");
                        Thread.Sleep(6000);
                        return;
                    }
                ...
                case "C":
                    ...
                    else 
                    {
                        ...
                        byte antiguedad;
                        double bono;
                        Console.WriteLine("Ingresa la antiguedad en años del maestro");
                        ...
                        if (antiguedad >= 5)
                        {
                            ...
                            Console.WriteLine("El maestro de nombre: {0}, con categoria {1}, y un total" +
                            "de {2} horasa a la semana, tendra una remuneracion de ${3}," +
                            "quincenal con un bono de ${4}, un sueldo total de {5}.", nombre, categoria, numeroHoras, pagoTotal * 2, bono, pagoTotal * 2 + bono);
